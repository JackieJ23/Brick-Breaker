...
Flip_dir_t ball_hit_brick(Ball_vect_t futureBallPos, Ball_vect_t ballPos, Ball_vect_t ballDir)
{
	...
	bool negDiag = brick_array[ballPos.x - ballDir.x][ballPos.y + ballDir.y]; // Negative diagonal
	bool posDiag = brick_array[ballPos.x + ballDir.x][ballPos.y - ballDir.y]; // Positive diagonal
	bool wallHit = false;
	bool roofHit = false;
